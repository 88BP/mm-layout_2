...
function pathPrepare ($el) {
	...
	new TimelineMax()
		.add(TweenMax.to($title1, 1, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title2, 0.9, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title3, 1.5, {strokeDashoffset: 0, ease:Linear.easeNone}))
		new TimelineMax() 
		.add(TweenMax.to($title4, 0.9, {strokeDashoffset: 0, ease:Linear.easeNone}))
		new TimelineMax() 
		...
		new TimelineMax()
		.add(TweenMax.to($title8, 0.9, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title9, 1, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		...
		new TimelineMax() 
		.add(TweenMax.to($title13, 1.8, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title14, 0.9, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title15, 2, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title16, 1.1, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
		.add(TweenMax.to($title17, 0.9, {strokeDashoffset: 0, ease:Linear.easeNone})) 
		new TimelineMax()
